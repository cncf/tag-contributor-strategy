		...
		<div class="slider">
			<div class="slide background-image-wrapper">
				...
				<div class="background-image-text-overlay">
					<h2>Contributors 
						<span> </span><br class="show-over-768" />shape the cloud
						<span> </span><br class="show-over-768" />native landscape
					</h2>
				</div>
			</div>
			<div class="slide background-image-wrapper">
				...
				<div class="background-image-text-overlay">
					<h2>Grow flourishing, 
						<span> </span><br class="show-over-768" />sustainable 
						<span> </span><br class="show-over-768" />communities</h2>
				</div>
			</div>
			<div class="slide background-image-wrapper">
				<figure class="background-image-figure">
				...
				<div class="background-image-text-overlay">
					<h2>And drive
						<span> </span><br class="show-over-768" />CNCF project
						<span> </span><br class="show-over-768" />lifecycles
					</h2>
				</div>
			</div>
		</div>
