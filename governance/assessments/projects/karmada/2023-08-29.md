...
* Update the list of maintainers and create emeritus status
...
The [Approvers](https://github.com/karmada-io/community/blob/main/APPROVERS.md) is a relatively new so seems to be up to date while the [Reviewers](https://github.com/karmada-io/community/blob/main/REVIEWERS.md) has not been updated very much since it was created. This is also out of sync with the nubmer listed in the incubation proposal, but it may be because that document was created in December 2022.
